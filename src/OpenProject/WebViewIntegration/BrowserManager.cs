  ...
  public partial class BrowserManager
  {
    ...
    public BrowserManager(ChromiumWebBrowser webBrowser)
    {
      ...
      DependencyPropertyDescriptor
        ...
        {
          var newUrl = _webBrowser.Address;
      ...
      _webBrowser.DownloadHandler = new DownloadHandler();
    ...
    {
      JavascriptResponse revitBridgeIsPresentCheckResponse = await _webBrowser.GetMainFrame()
      ...
      _webBrowser.JavascriptObjectRepository.Register(JavaScriptBridge.REVIT_BRIDGE_JAVASCRIPT_NAME,
        new BcfierJavascriptInterop(), true);
